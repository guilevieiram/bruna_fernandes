...
function MediaLink({image, hoverName, link}){
    ...
    return(
        <a key={link} onMouseEnter={toggleHover} onMouseLeave={toggleHover} href={link}  className="h-6 w-6 m-4 transform transition-all hover:-translate-y-1 flex items-center">
