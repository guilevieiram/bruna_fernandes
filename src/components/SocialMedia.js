...
function MediaLink({image, hoverName, link, key}){
    ...
    return(
        <a href={link} key={key} className="h-6 w-6 m-4 transform transition-all hover:-translate-y-1 flex items-center">
            <img src={image} alt={hoverName}  title={hoverName} onMouseEnter={toggleHover} onMouseLeave={toggleHover}/>
